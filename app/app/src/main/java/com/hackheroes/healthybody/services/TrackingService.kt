...
import com.hackheroes.healthybody.util.Constants.Companion.LOCATION_UPDATE_INTERVAL
import com.hackheroes.healthybody.util.Constants.Companion.NOTIFICATION_CHANNEL_ID
import com.hackheroes.healthybody.util.Constants.Companion.NOTIFICATION_CHANNEL_NAME
import com.hackheroes.healthybody.util.Constants.Companion.NOTIFICATION_ID
import com.hackheroes.healthybody.util.Constants.Companion.TIMER_UPDATE_INTERVAL
...
class TrackingService : LifecycleService() {
    ...
    private fun startForegroundService() {
        ...
        val notificationBuilder = NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID)
            .setAutoCancel(false)
            .setOngoing(true)
            .setSmallIcon(R.drawable.heart_hdpi)
